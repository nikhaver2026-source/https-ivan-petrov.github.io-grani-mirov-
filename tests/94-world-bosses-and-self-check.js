...
(async()=>{
 ...
 check('2. предвестники по трём ярусам, каждый раз со звуком со стороны логова, объявляются раз; за сорок шагов — тишина; «Владыки» говорят направлением',
  предв.далеко.сказ===""&&/на ветру/.test(предв.т1.сказ)&&предв.т1.звуки.includes("score_lava")&&предв.т1повтор.сказ===""&&/сер/.test(предв.т2.сказ)&&предв.т2.звуки.includes("oc_quake")&&/Пепельный Владыка/.test(предв.т3.сказ)&&предв.т3.звуки.includes("tuba_boss")&&предв.т3повтор.сказ===""&&/Владык земель 6/.test(предв.текст)&&/шагов/.test(предв.текст),
