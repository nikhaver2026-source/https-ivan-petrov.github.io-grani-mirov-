/* ═══════════════════════════════════════════════════════════════════════
   ...
   6. Армии: численность, мораль, снабжение, разведка, транспорт, чары;
      фронт двигается сам; служба разведкой, подвозом, вылазкой и
      командованием по одному разу в день.
...
(async()=>{
 ...
 check('разговор заводит судьбу жителя с возрастом, семьёй, имуществом, долгами и травмами; ступень судьбы пишется в летопись и отголоски; строка судьбы есть в окне; смерть оставляет наследство',
  судьбы.завели&&судьбы.поля.length===0&&судьбы.повтор&&судьбы.шаг&&судьбы.шагов>=1&&судьбы.летопись&&судьбы.отголосок&&/🧓/.test(судьбы.line||"")&&судьбы.умер&&судьбы.наследство&&/Судеб на памяти/.test(судьбы.text),судьбы);
 ...
 const окно=await page.evaluate(async()=>{
  ...
  return r;});
 check('окно «Живой мир» с семью разделами, четырьмя службами в войске и шестью пророчествами, говорит состояние; строка в меню действий',
  окно.окно==="modal-living"&&окно.секции.length===0&&окно.служба===4&&окно.пророчества===6&&окно.сказано.length>0&&окно.меню,окно);
