/* ═══════════════════════════════════════════════════════════════════════
   ...
   5. Заставка (с 3.9 — intro_05.ogg): голос Gemini и эффекты, 320 кбит/с,
...
(async()=>{
 ...
 check('5. заставка: intro_05.ogg — 320 кбит/с, стерео, 44,1 кГц, 30–55 с; прежних записей нет; титры называют голос и эффекты',
  файл==="intro/intro_05.ogg"&&!!инфо&&инфо.br>=320&&инфо.ch===2&&инфо.sr===44100&&инфо.dur>=30&&инфо.dur<=55
  &&!fs.existsSync(path.join(SND,'intro','intro_01.ogg'))&&!fs.existsSync(path.join(SND,'intro','intro_02.ogg'))
  &&/Gemini/.test(титры)&&/Charon/.test(титры)&&/Sonic Pi/.test(титры)&&/OpenClonk/.test(титры)
