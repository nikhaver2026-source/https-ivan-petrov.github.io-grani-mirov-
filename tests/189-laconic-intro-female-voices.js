...
(async()=>{
 ...
 check('5. заставка: intro_02.ogg — 320 кбит/с, стерео, 44,1 кГц, 30–45 с; прежней записи нет; титры называют голос и эффекты',
  файл==="intro/intro_02.ogg"&&!!инфо&&инфо.br>=320&&инфо.ch===2&&инфо.sr===44100&&инфо.dur>=30&&инфо.dur<=45
  &&!fs.existsSync(path.join(SND,'intro','intro_01.ogg'))
  &&/Supertonic 3/.test(титры)&&/OpenRAIL-M/.test(титры)&&/Sonic Pi/.test(титры)&&/OpenClonk/.test(титры)
