/* ═══════════════════════════════════════════════════════════════════════
   ...
   5. Заставка (с 3.9 — intro_07.ogg): голос Gemini и эффекты, 320 кбит/с,
...
(async()=>{
 ...
 check('5. заставка: intro_07.ogg — 320 кбит/с, стерео, 44,1 кГц, 30–60 с; прежних записей нет; титры называют голос и эффекты',
  файл==="intro/intro_07.ogg"&&!!инфо&&инфо.br>=320&&инфо.ch===2&&инфо.sr===44100&&инфо.dur>=30&&инфо.dur<=60
