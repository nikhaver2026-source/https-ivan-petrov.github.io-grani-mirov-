...
(async()=>{
 ...
 check('1. тридцать четыре школы пяти семейств с силой и звуками из банка; все исходные заклинания приписаны к школе',
  школы.n===34&&школы.уник===34&&школы.семейств===5&&школы.плохие.length===0&&школы.исходные.length===12&&школы.безШколы.length===0,
