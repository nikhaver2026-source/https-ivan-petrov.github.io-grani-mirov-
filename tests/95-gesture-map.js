...
(async()=>{
 ...
 check('1а. одиночное касание поля ничего не выполняет, двойное — действие здесь (набор 176)',одно.length===0&&два.includes("useHere"),{одно,два});
 await page.evaluate(()=>{safeFn(()=>openActionMenu("here"));});await page.waitForTimeout(200);
