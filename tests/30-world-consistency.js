...
(async()=>{
 ...
 const имена=await page.evaluate(()=>{
  ...
  out.качеств=QUAL.length;out.материалов=MAT.length;
  return out;});
 ...
 check('имя вещи согласовано в роде во всех сочетаниях качества и материала',
  имена.плохие.length===0&&имена.всего===9*QUAL_LEN*MAT_LEN,
