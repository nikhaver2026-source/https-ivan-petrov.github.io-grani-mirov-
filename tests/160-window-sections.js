/* ═══════════════════════════════════════════════════════════════════════
   ...
   9. Настройки разбиты на одиннадцать разделов, и ни одна не пропала.
...
(async()=>{
 ...
 const настройки=await page.evaluate(()=>{
  ...
  return r;});
 check('настройки разбиты на одиннадцать разделов с разными именами, и у каждого своя подпись',
  настройки.разделов===11&&new Set(настройки.имена).size===11
  &&настройки.подписи===11,настройки);
