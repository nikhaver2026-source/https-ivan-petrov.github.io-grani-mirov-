...
(async()=>{
 ...
 check('действий двадцать девять, у каждого имя, слово и настоящий вызов, а первое — «нет команды»',
  состав.действий===29&&состав.уникД===29&&состав.первое==="none"
 ...
 check('раздел настроек показывает все тридцать три фигуры списками из двадцати девяти действий, у каждого списка есть имя, и есть кнопка возврата',
  настройки.ok===true&&настройки.списков===33&&настройки.опций===29
