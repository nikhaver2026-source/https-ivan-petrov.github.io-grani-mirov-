/* ═══════════════════════════════════════════════════════════════════════
   ...
   1. Тринадцать зданий, десять цепей, двадцать пять полуфабрикатов,
      двадцать девять переделов — и у каждого здания свой станок с именем.
...
(async()=>{
 ...
 check('тринадцать производственных зданий, десять цепей, двадцать пять полуфабрикатов, двадцать девять переделов',
  состав.зданий===13&&состав.цепей===10&&состав.товаров===25&&состав.переделов===29,состав);
 ...
 check('три цепи кончаются вещью, а не припасом',сплет.вещей===3&&сплет.мечВещь,сплет);
 ...
 check('README рассказывает о переделах и мастерских',
  ...
  &&/клеёного бруса/i.test(readme)&&/двадцать девять переделов/i.test(readme));
