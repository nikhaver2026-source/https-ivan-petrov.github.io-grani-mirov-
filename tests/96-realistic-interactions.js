...
(async()=>{
 ...
 const роли=["uh_page","arte_page","arte_gem","arte_metal","arte_coins","artifact_hum","oc_chest_open","choir","ad_temple","uh_chapel","bell_small","market_slap","forge_hammer","deep_cart","hall_house","market_tap","ad_trade","beasts_camel","hero_heart","lug_growl","lug_snarl","beast_growl","ad_leaves","lug_bush","oc_glass_hit","cast_heal","cast_shock","cast_ice","cast_fire","magic_woosh","magic_shimmer","es_magic","wraith_voice","oc_warp","raptor_wing","mtg_door_close","amb_fire","dread","stk_rain","sky_gust","amb_wind","clang_splash"];
