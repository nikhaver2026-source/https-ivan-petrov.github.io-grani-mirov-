...
(async()=>{
 ...
 /* Шестнадцать тем SuperTuxKart ушли: игра гоночная, музыку мест дают
    фэнтезийные игры. Живых записей стихий и ремесла осталось двадцать четыре. */
 check('двадцать четыре записи SuperTuxKart на месте и читаются браузером',
  стк.файлов>=24&&стк.битые.length===0,{файлов:стк.файлов,битые:стк.битые.slice(0,5)});
