...
(async()=>{
 ...
 check('двойное касание одним пальцем по полю ничего не собирает и молчит: поле одному пальцу не отвечает',
  Object.keys(dbl.запас).length===0&&!dbl.сказано.some(t=>/Собрано/.test(t)),dbl);
