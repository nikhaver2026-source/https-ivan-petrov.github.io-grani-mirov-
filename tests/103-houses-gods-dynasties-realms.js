...
(async()=>{
 ...
 check('пантеон показывает раздел малых богов: тридцать две строки, счёт тридцать два и тридцать девять, кнопки молитвы в храме',
  боги.пантеон&&боги.пантеон.строк===32&&боги.пантеон.шапка&&боги.пантеон.молиться,боги.пантеон);
