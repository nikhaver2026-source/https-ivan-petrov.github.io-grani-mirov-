...
(async()=>{
 ...
 /* Владения держат первые семнадцать: остальные десять приходят к тем, кто
    позвал, и своей земли не имеют. */
 check('двадцать семь тёмных богов, и семнадцать из них держат владения',
  реестр.богов===27&&реестр.владений===17,реестр);
 check('пятьдесят два народа, от низших до божественных',
  реестр.народов===52&&реестр.рангов===5,реестр);
 /* Мест стало девять: к семи прежним прибавились твердыня и посад — города
    за Гранью. */
 check('своя земля, свои твари, свои места и свои платы',
  реестр.земель===7&&реестр.тварей>=24&&реестр.мест===9&&реестр.плат===7&&реестр.родов===13,реестр);
 ...
 check('в них встречаются все тринадцать родов дела, все двадцать семь богов и все шесть родов награды',
  дела.родов===13&&дела.богов===27&&дела.наград===6,дела);
