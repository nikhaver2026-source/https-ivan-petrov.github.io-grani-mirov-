...
(async()=>{
 ...
 check('престолов восемь и все внутри мира',
  престолы.держав===8&&!престолы.вне.length,престолы.вне);
 check('престолы стоят на разных местах',престолы.разных===8,престолы.разных);
