...
(async()=>{
 ...
 /* Двенадцать исходных чар плюс сто четырнадцать именных по школам (набор
    147 добавил четыре школы, и каждая принесла свои три): ни одна из ста
    двадцати шести не должна быть вечным источником маны. */
 check('сто двадцать шесть заклинаний, каждое творится и тратит ману',
  !закл.плохие.length&&закл.всего===126&&закл.исходных===12&&закл.школьных===114,
