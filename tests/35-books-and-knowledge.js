/* ════════════════════════════════════════════════════════════════════════
   ...
   четырнадцать навыков и шестнадцать предметов обстановки, с каждым из
   которых можно что-то сделать. Отдельно проверяется главное правило игры:
...
(async()=>{
 ...
 check('шестнадцать предметов обстановки, и каждый что-то делает',
  !вещи.плохие.length&&вещи.всего===16,{плохие:вещи.плохие.slice(0,4),всего:вещи.всего});
