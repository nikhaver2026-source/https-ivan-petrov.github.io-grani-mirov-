...
(async()=>{
 ...
 /* ── 4. Список закрыт ──
    ...
    замены — без потерь, поэтому в список не входят. */
 check('список старых записей закрыт: ровно 1267 строк, ни одной новой',
  старые.size===1267,{вСписке:старые.size,надо:1267});
