...
(async()=>{
 ...
 /* ── 4. Список закрыт ──
    ...
    кбит/с из несжатого синтеза, в список не входят. */
 check('список старых записей закрыт: ровно 1233 строки, ни одной новой',
  старые.size===1233,{вСписке:старые.size,надо:1233});
