...
**Источник:** [endless-sky/endless-sky](https://github.com/endless-sky/endless-sky),
папка `sounds/`. Лицензии взяты из их файла `copyright`.

**Лицензии:** папка `sounds/*` объявлена общественным достоянием («Based on public
domain sounds taken from freesound.org»); отдельные записи идут под
...
|---|---|---|---|
| `acuit.ogg` | высокий сигнал | endless-sky contributors, freesound.org | общественное достояние |
| `alarm.ogg` | тревога | endless-sky contributors, freesound.org | общественное достояние |
| `archonteleport.ogg` | переход | endless-sky contributors, freesound.org | общественное достояние |
| `asteroid_crunch_large.ogg` | камень крошится | endless-sky contributors, freesound.org | общественное достояние |
| `asteroid_crunch_medium.ogg` | камень крошится | endless-sky contributors, freesound.org | общественное достояние |
| `asteroid_crunch_small.ogg` | камень крошится | endless-sky contributors, freesound.org | общественное достояние |
| `astral_attack.ogg` | удар бездны | endless-sky contributors, freesound.org | общественное достояние |
| `astral_cetacean.ogg` | голос из бездны | endless-sky contributors, freesound.org | общественное достояние |
| `astuit.ogg` | сигнал | endless-sky contributors, freesound.org | общественное достояние |
| `bludgeon_impact.ogg` | тяжёлый удар | endless-sky contributors, freesound.org | общественное достояние |
| `bounce.ogg` | отскок | endless-sky contributors, freesound.org | общественное достояние |
| `buzzer_am.ogg` | зуммер | endless-sky contributors, freesound.org | общественное достояние |
| `clink.ogg` | звяк | endless-sky contributors, freesound.org | общественное достояние |
| `crunch.ogg` | хруст | endless-sky contributors, freesound.org | общественное достояние |
| `dragonflame.ogg` | драконий огонь | endless-sky contributors, freesound.org | общественное достояние |
| `drill.ogg` | бур | endless-sky contributors, freesound.org | общественное достояние |
...
| `ion_medium.ogg` | ионный гул | endless-sky contributors, freesound.org | общественное достояние |
...
| `plasma_medium.ogg` | плазменный гул | endless-sky contributors, freesound.org | общественное достояние |
| `plasma_small.ogg` | плазменный гул | endless-sky contributors, freesound.org | общественное достояние |
| `pwave.ogg` | волна | endless-sky contributors, freesound.org | общественное достояние |
| `scan.ogg` | скан | endless-sky contributors, freesound.org | общественное достояние |
| `speckle.ogg` | россыпь | endless-sky contributors, freesound.org | общественное достояние |
